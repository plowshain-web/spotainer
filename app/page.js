...
textarea: {
  ...
  incompleteBox: {
    ...
    marginBottom: 6,
    height: "clamp(388px, calc(100dvh - 452px), 424px)",
    minHeight: 0,
    boxSizing: "border-box",
  ...
  incompleteList: {
    display: "grid",
    gridTemplateColumns: "repeat(5, minmax(0, 1fr))",
    gridTemplateRows: "minmax(214px, 1fr) 52px",
    gap: 10,
    alignItems: "stretch",
  ...
  incompleteItem: {
    ...
    minWidth: 0,
    minHeight: 0,
    boxShadow: "inset 0 1px 0 rgba(255,255,255,0.055), 0 0 0 1px rgba(255,255,255,0.02), 0 9px 20px rgba(0,0,0,0.18), 0 0 12px rgba(246,211,139,0.10)",
  },
  compactScheduleHead: {
    display: "grid",
  ...
  compactWorkoutRow: {
    display: "grid",
    gridTemplateColumns: "38px minmax(42px, 1fr) 1px 30px auto",
    alignItems: "center",
    gap: 7,
    minHeight: 39,
  },
