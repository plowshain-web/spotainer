...
textarea: {
  ...
  incompleteBox: {
    background: "linear-gradient(180deg, rgba(22,27,29,0.96), rgba(7,11,13,0.985))",
    border: "1.35px solid rgba(214, 157, 48, 0.78)",
    borderRadius: 16,
    padding: "16px 20px 18px",
    marginBottom: 16,
    height: "clamp(420px, calc(100dvh - 300px), 520px)",
    minHeight: 0,
    boxSizing: "border-box",
    boxShadow: "inset 0 1px 0 rgba(255,255,255,0.045), 0 16px 42px rgba(0,0,0,0.30), 0 0 18px rgba(214,157,48,0.08)",
    flexShrink: 0,
  },
  incompleteTop: {
    display: "flex",
  ...
  incompleteItem: {
    position: "relative",
    background: "linear-gradient(180deg, rgba(24,29,31,0.90), rgba(7,11,13,0.985))",
    border: "1.2px solid rgba(214, 157, 48, 0.72)",
    borderRadius: 10,
    ...
    minWidth: 0,
    minHeight: 0,
    boxShadow: "inset 0 1px 0 rgba(255,255,255,0.05), 0 10px 24px rgba(0,0,0,0.22), 0 0 10px rgba(214,157,48,0.07)",
  },
  compactScheduleHead: {
    display: "grid",
  ...
  compactWorkoutRow: {
    display: "grid",
    gridTemplateColumns: "42px minmax(42px, 1fr) 1px 30px auto",
    alignItems: "center",
    gap: 8,
    minHeight: 58,
  },
  ...
  homeLauncherItem: {
    ...
    height: 122,
    minHeight: 0,
    border: "1.1px solid rgba(214, 157, 48, 0.62)",
