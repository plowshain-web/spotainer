...
const preferenceGroups = [
  ...
  },
  {
    ...
    options: [
      "세세하게 관리해주세요 (식단, 생활습관도 같이 체크받고 싶어요)",
  ...
  },
  {
    ...
    options: [
      "편하게 장난치면서 해주세요 (너무 딱딱한 분위기는 싫어요)",
      "담백하게 해주세요 (과한 리액션은 부담스러워요)",
  ...
  },
  {
    ...
    options: [
      "편하게 대화하면서 하고 싶어요 (수업 분위기가 편한 게 좋아요)",
      "필요한 말만 해주세요 (운동에 집중하는 편이 좋아요)",
      "먼저 물어봐주면 편해요 (제가 먼저 말하는 건 조금 어려워요)",
    ],
  },
  {
