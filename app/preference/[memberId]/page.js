...
const preferenceGroups = [
  {
    ...
    title: "트레이닝 스타일",
    desc: "운동할 때 어떤 방식이 편한지 체크해주세요. (중복 선택 가능)",
    options: [
  ...
  },
  {
    ...
    title: "관리 스타일",
    desc: "운동 외에 식단, 생활습관, 컨디션 관리를 어느 정도 원하시는지 체크해주세요. (중복 선택 가능)",
    options: [
  ...
  },
  {
    ...
    title: "대화 스타일",
    desc: "수업 중 대화 방식에 대해 편한 쪽을 체크해주세요. (중복 선택 가능)",
    options: [
  ...
  },
  {
    ...
    title: "수업 분위기",
    desc: "원하시는 수업 분위기에 가까운 항목을 체크해주세요. (중복 선택 가능)",
    options: [
      "밝고 편한 분위기가 좋아요",
      "차분하게 운동하는 분위기가 좋아요",
      "컨디션에 맞춰 조절해주세요",
